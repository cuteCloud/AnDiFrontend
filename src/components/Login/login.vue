  ...
  <div class="login">
      <div class="loginBox" :class="loginIng==true?'active':''" style="margin-top: ">
        ...
        <div class="username">
          ...
          <input class="login-input user"  v-model="login.username" v-verify.login="login.username" type="text" placeholder="请输入用户名...">
          <div v-remind="login.username" class="bar"></div>
        </div>
        <div class="password">
          <p class="iconfont icon-lock"></p>
          <input class="login-input pwd" v-model="login.pwd" v-verify.login="login.pwd" type="password" placeholder="请输入密码...">
  ...
  export default{
   ...
   /* beforeRouteEnter (to, from, next) {
    ...
    created:function () {
            ...
            children:[
              {
                path: '/courseToday',
                name: '今日课程',
                component: '../../components/rightDetail/businessOperation/course/courseToday.vue',
              },
              {
                path: '/addCourse',
                name: '添加课程',
                component: '../../components/rightDetail/businessOperation/course/addCourse.vue',
              },
              {
                path: '/memberBusiness',
                name: '会员业务',
                component: '../../components/rightDetail/businessOperation/member/memberBusiness.vue',
              }
            ]
          },
          {
            ...
            children:[
              {
                ...
                name: '公司设置',
                component:'../../components/rightDetail/companyManage/companySet/companySet.vue',
              },
              {
                path: '/companyManage/departmentSet',
                name: '部门设置',
                component: '../../components/rightDetail/companyManage/departmentSet/departmentSet.vue',
              }
            ]
          },
          {
      ...
      /*this.$store.commit('setAsyRouters',asyRouters)*/
    },
    methods:{
          signUp:function () {
            if(this.$verify.check("login")){
               ...
               _this.$router.push({ path: '/businessOperation'});
               }else {
...
<style scoped>
  ...
  .bar{text-align: left;margin: 5px;font-size: 14px;color: #a71d5d}
  .loginIng{
    width: 200px;
    height: 100px;
    box-sizing: border-box;
